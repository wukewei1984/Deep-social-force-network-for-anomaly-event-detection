  ...
  with tf.Graph().as_default():
    ...
    for gpu_index in range(0, gpu_num):
      with tf.device('/gpu:%d' % gpu_index):
        ...
        # for i in range(10):
        #       img_conv = tf.nn.conv2d(d[i],conv_filter,strides=[1,1,1,1], padding='SAME')
        #       img_deconv = tf.nn.conv2d_transpose(img_conv,conv_filter,g,strides=[1,1,1,1], padding='SAME')
